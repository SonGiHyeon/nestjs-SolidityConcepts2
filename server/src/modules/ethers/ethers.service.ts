...
export class EthersService {
  ...
  async sentValue() {
    ...
    const valueInWei = await this.contract.sentValue();
    return formatEther(valueInWei);
  }
  ...
  async generateHash(message: string) {
    ...
    return this.contract.generateHash(message);
  }
